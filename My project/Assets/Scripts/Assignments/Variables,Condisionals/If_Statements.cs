...
public class If_Statements : MonoBehaviour
{
    ...
    */
    ...
    {
        Debug.log("The Weather is Stormy You Wear a Coat")
    }
    else if(weather is "Sunny" || "Partly Cloudy")
    {
 ...
 if(magic == Pink)
    ...
    else if(vision is < ("clear") && vision > ("pretty"))
    {
